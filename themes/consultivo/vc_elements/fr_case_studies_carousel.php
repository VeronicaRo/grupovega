...
$args = array(
    ...
    'params' => array(
        ...
        array(
            ...
            'shortcode' => 'fr_case_studies_carousel',
            'heading' => esc_html__('Shortcode Template', 'consultivo'),
            'std' => 'fr_case_studies_carousel.php',
        ...
        array(
            'type'       => 'dropdown',
            'heading'    => esc_html__('Display Row', 'consultivo'),
...
class WPBakeryShortCode_fr_case_studies_carousel extends CmsShortCode
{
