...
$args = array(
    'name' => 'Blog Carousel',
    'base' => 'fr_blog_carousel',
    'class' => 'vc-cms-blog-carousel',
    'icon' => 'cs_icon_for_vc',
    ...
    'params' => array(
        ...
        array(
            ...
            'shortcode' => 'fr_blog_carousel',
            'heading' => esc_html__('Shortcode Template', 'consultivo'),
            'std' => 'fr_blog_carousel.php',
...
class WPBakeryShortCode_fr_blog_carousel extends CmsShortCode
{
