...
vc_map(
    array(
        'name'     => esc_html__('Blog Grid', 'consultivo'),
        'base'     => 'fr_blog_grid',
        ...
        'params'   => array(
            ...
            array(
                'type'       => 'dropdown',
                'heading'    => esc_html__('Pagination Type', 'consultivo'),
...
class WPBakeryShortCode_fr_blog_grid extends CmsShortCode
{
    protected function content($atts, $content = null)
    {
        $html_id = cmsHtmlID('fr-blog-grid');
