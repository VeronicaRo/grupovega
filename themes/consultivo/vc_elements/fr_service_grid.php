...
vc_map(
    array(
        'name'     => esc_html__('Service Grid', 'consultivo'),
        'base'     => 'fr_service_grid',
        'class'    => 'vc-cms-service-grid',
        'icon' => 'cs_icon_for_vc',
        ...
        'params'   => array(
            array(
                ...
                'shortcode' => 'fr_service_grid',
                'heading' => esc_html__('Shortcode Template', 'consultivo'),
                'std' => 'fr_service_grid.php',
            ...
            array(
                'type'       => 'checkbox',
                'heading'    => esc_html__('Show Icon', 'consultivo'),
...
class WPBakeryShortCode_fr_service_grid extends CmsShortCode
{
    protected function content($atts, $content = null)
    {
        $html_id = cmsHtmlID('fr-service-grid');
