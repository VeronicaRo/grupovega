...
?>
<div id="<?php echo esc_attr($atts['html_id']);?>" class="cms-heading-layout layout2 <?php echo esc_attr( $el_parallax_class.' '.$align_lg.' '.$align_md.' '.$align_sm.' '.$align_xs.' '.$animation_classes ); ?>" <?php echo esc_attr($parallax_speed); ?>>
