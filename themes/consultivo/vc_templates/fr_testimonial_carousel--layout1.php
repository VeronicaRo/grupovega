...
if(!empty($testimonials)) : ?>
    <div class="carousel-has-icon-bg">
        <div id="<?php echo esc_attr($html_id);?>" class="fr-testimonial-carousel layout1 owl-carousel <?php echo esc_attr( $el_parallax_class.' '.$el_class ); ?>" <?php echo !empty($carousel_data) ?  esc_attr($carousel_data) : '' ?> <?php echo esc_attr($parallax_speed); ?>>
                ...
                <div class="fr-testimonial-item <?php echo esc_attr( $animation_classes ); ?>">
                    <div class="fr-testimonial-item-inner">
                        ...
                        <?php if(!empty($image_url)): ?>
                            <div class="fr-testimonial-image">
                             <?php
                             $default_size = 'full';
