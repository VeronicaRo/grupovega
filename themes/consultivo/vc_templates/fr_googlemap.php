...
extract(shortcode_atts(array(
    'api' => 'AIzaSyCCiVYiUyjDnoO9nC36gYP0sEIU-Ladx3c',
...
<div class="fr-google-map style-<?php echo esc_attr( $styles ); ?> <?php echo esc_attr($el_parallax_class); ?>" <?php echo esc_attr($parallax_speed); ?>>
