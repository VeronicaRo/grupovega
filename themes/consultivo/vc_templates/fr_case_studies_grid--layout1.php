...
?>
<div id="<?php echo esc_attr($html_id) ?>" class="fr-grid fr-case-studies-grid default <?php echo esc_attr($el_parallax_class.' '.$el_class); ?>" <?php echo esc_attr($parallax_speed); ?>>
