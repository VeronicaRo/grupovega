...
<div id="<?php echo esc_attr($html_id) ?>" class="fr-grid fr-service-grid <?php echo esc_attr($el_parallax_class.' '.$el_class); ?>" <?php echo esc_attr($parallax_speed); ?>>
                        ...
                        <div class="service-item-grid-default <?php echo esc_attr($style);?>">
                            <div class="fr-fancybox-inner clearfix">
                                <div class="item-icon">
                                 ...
                                 $image_icon = get_post_meta($post->ID, 'icon', true);
                                 ?>
                                 <?php if(!empty($image_icon['url'])) : ?>
                                    <div class="item-icon">
