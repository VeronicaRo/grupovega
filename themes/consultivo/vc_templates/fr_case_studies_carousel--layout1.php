...
<div id="<?php echo esc_attr($html_id) ?>" class="fr-case-studies-carousel  owl-carousel animation-time <?php echo esc_attr( $el_parallax_class.' '.$el_class ); ?>" <?php echo !empty($carousel_data) ?  esc_attr($carousel_data) : '' ?> <?php echo esc_attr($parallax_speed); ?>>
    <?php if (is_array($posts)):
        ...
        foreach ($posts as $post) {
            ...
            $count++;
            ?>
            <div class="grid-item-inner layout1">
