...
<header id="masthead" class="site-header">
    <div id="site-header-wrap" class="header-layout1 header-layout3 header-layout6 header-layout8 <?php if($sticky_on == 1) { echo 'is-sticky'; } ?>">
        <div class="clearfix">
                    ...
                    <div class="col-text-right">
                        <ul>
                            ...
                            <?php if($show_custom_button){?>
                                <li>
                                    <ul>
                                        <li class="button-link"><a class="btn btn-primary" href="<?php echo esc_url($page_url); ?>"><?php echo esc_html($h_btn_text); ?></a></li>
                                    </ul>
                                </li>
                            <?php } ?>
