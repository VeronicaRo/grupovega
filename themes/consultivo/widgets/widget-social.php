...
class CS_Social_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_html__('CMS Social', 'consultivo'), // Name
            array('description' => esc_html__('Social Widget', 'consultivo'),) // Args
        );
    }
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Social', 'consultivo' ) : $instance['title'], $instance, $this->id_base);
        }
        ...
        if (!empty($title))
            ...
            if ($link_facebook != '') {
                echo '<li><a target="_blank" href="'.esc_url($link_facebook).'"><i class="'.$icon_facebook.'"></i><span>'.esc_html__('Facebook', 'consultivo').'</span></a></li>';
            }

            if ($link_rss != '') {
                echo '<li><a target="_blank" href="'.esc_url($link_rss).'"><i class="'.$icon_rss.'"></i><span>'.esc_html__('Rss', 'consultivo').'</span></a></li>';
            }

            if ($link_youtube != '') {
                echo '<li><a target="_blank" href="'.esc_url($link_youtube).'"><i class="'.$icon_youtube.'"></i><span>'.esc_html__('YouTube', 'consultivo').'</span></a></li>';
            }

            if ($link_twitter != '') {
                echo '<li><a target="_blank" href="'.esc_url($link_twitter).'"><i class="'.$icon_twitter.'"></i><span>'.esc_html__('Twitter', 'consultivo').'</span></a></li>';
            }

            if ($link_google != '') {
                echo '<li><a target="_blank" href="'.esc_url($link_google).'"><i class="'.$icon_google.'"></i><span>'.esc_html__('Google+', 'consultivo').'</span></a></li>';
            }

            if ($link_skype != '') {
                echo '<li><a target="_blank" href="'.esc_url($link_skype).'"><i class="'.$icon_skype.'"></i><span>'.esc_html__('Skype', 'consultivo').'</span></a></li>';
            }

            if ($link_dribbble != '') {
                echo '<li><a target="_blank" href="'.esc_url($link_dribbble).'"><i class="'.$icon_dribbble.'"></i><span>'.esc_html__('Dribbble', 'consultivo').'</span></a></li>';
            }

            if ($link_flickr != '') {
                echo '<li><a target="_blank" href="'.esc_url($link_flickr).'"><i class="'.$icon_flickr.'"></i><span>'.esc_html__('Flickr', 'consultivo').'</span></a></li>';
            }

            if ($link_linkedin != '') {
                echo '<li><a target="_blank" href="'.esc_url($link_linkedin).'"><i class="'.$icon_linkedin.'"></i><span>'.esc_html__('Linkedin', 'consultivo').'</span></a></li>';
            }

            if ($link_vimeo != '') {
                echo '<li><a target="_blank" href="'.esc_url($link_vimeo).'"><i class="'.$icon_vimeo.'"></i><span>'.esc_html__('Vimeo', 'consultivo').'</span></a></li>';
            }

            if ($link_pinterest != '') {
                echo '<li><a target="_blank" href="'.esc_url($link_pinterest).'"><i class="'.$icon_pinterest.'"></i><span>'.esc_html__('Pinterest', 'consultivo').'</span></a></li>';
            }

            if ($link_bloglovin != '') {
                echo '<li><a target="_blank" href="'.esc_url($link_bloglovin).'"><i class="'.$icon_bloglovin.'"></i><span>'.esc_html__('Bloglovin', 'consultivo').'</span></a></li>';
            }

            if ($link_instagram != '') {
                echo '<li><a target="_blank" href="'.esc_url($link_instagram).'"><i class="'.$icon_instagram.'"></i><span>'.esc_html__('Instagram', 'consultivo').'</span></a></li>';
            }
    ...
    function form( $instance ) {
         ...
         ?>
         <p><label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e( 'Title:', 'consultivo' ); ?></label>
         <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('title') ); ?>" name="<?php echo esc_attr( $this->get_field_name('title') ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" /></p>

         <p><label for="<?php echo esc_attr($this->get_field_id('link_facebook')); ?>"><?php esc_html_e( 'Link Facebook:', 'consultivo' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_rss')); ?>"><?php esc_html_e( 'Link Rss:', 'consultivo' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_youtube')); ?>"><?php esc_html_e( 'Link Youtube:', 'consultivo' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_twitter')); ?>"><?php esc_html_e( 'Link Twitter:', 'consultivo' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_google')); ?>"><?php esc_html_e( 'Link Google:', 'consultivo' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_skype')); ?>"><?php esc_html_e( 'Link Skype:', 'consultivo' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_dribbble')); ?>"><?php esc_html_e( 'Link Dribbble:', 'consultivo' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_flickr')); ?>"><?php esc_html_e( 'Link Flickr:', 'consultivo' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_linkedin')); ?>"><?php esc_html_e( 'Link Linkedin:', 'consultivo' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_vimeo')); ?>"><?php esc_html_e( 'Link Vimeo:', 'consultivo' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_pinterest')); ?>"><?php esc_html_e( 'Link Pinterest:', 'consultivo' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_bloglovin')); ?>"><?php esc_html_e( 'Link Bloglovin:', 'consultivo' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_instagram')); ?>"><?php esc_html_e( 'Link Instagram:', 'consultivo' ); ?></label>
